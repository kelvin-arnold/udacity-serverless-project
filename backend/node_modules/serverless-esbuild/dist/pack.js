...
const filterFilesForZipPackage = ({ files, fnNameWithoutStage, includedFiles, excludedFiles, hasExternals, isGoogleProvider, depWhiteList, }) => {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield Promise.all(buildResults.map(({ func, functionAlias, bundlePath }) => __awaiter(this, void 0, void 0, function* () {
            ...
            const filesPathList = (0, exports.filterFilesForZipPackage)({
                ...
                return (Object.assign({ localPath: localPath.replace(`__only_${fnNameWithoutStage}/`, '') }, rest));
            });
            const startZip = Date.now();
            yield (0, utils_1.zip)(artifactPath, filesPathList, this.buildOptions.nativeZip);
            const { size } = fs.statSync(artifactPath);
